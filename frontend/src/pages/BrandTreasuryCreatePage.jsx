...
import { ARTWORK_TYPES, OFFER_TYPES, LANGUAGES, PRIORITY, ZONES, CONTENT_TYPE_DOCUMENTS, BRAND_TREASURY_DOCUMENTS } from "../utils/constants"; // Assuming this is defined
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.attachment && !uploadedFileUrl) {
        ...
        const folderName = "brand-treasury";
              ...
              )}
            {
              activeTab === "specifications" && (
                <div className="flex flex-col gap-3">
                  ...
                  <textarea name="comment" value={formData.comment} onChange={handleChange} placeholder="comment" className="w-full border p-2 rounded mt-5"></textarea>
